...
namespace Unity1Week_Ura.Actor
{
    public class SmartPhoneView : AnimationViewBase
    {
        ...
        // Game
        public Observable<Post> OnNormalDraftDroppedToPublish => gamePhoneScreenView.OnNormalDraftDroppedToPublish;
        public Observable<ReplyDraftPublishRequest> OnReplyDraftDroppedToPublish => gamePhoneScreenView.OnReplyDraftDroppedToPublish;
        ...
        public Observable<Unit> OnGameSettingOpened => gamePhoneScreenView.OnSettingOpened;
        public Observable<Unit> OnGameSettingClosed => gamePhoneScreenView.OnSettingClosed;
        ...
        public void SetPlayerAccounts(IReadOnlyList<Account> accounts, Account selectedAccount = null)
            => gamePhoneScreenView.SetPlayerAccounts(accounts, selectedAccount);
